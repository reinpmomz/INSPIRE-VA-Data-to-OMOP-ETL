...
concepts_overall_agegroup_clinical_tables_omopsketch <- 
...
flextable::save_as_docx(values = concepts_overall_agegroup_clinical_tables_omopsketch, 
                        path = base::file.path(OMOPSketch_Dir, "concepts_overall_agegroup_clinical_tables_omopsketch.docx"),
